...
CMD:createlocker(playerid, params[])
{
	...
	new type;
	if(sscanf(params, "d", type)) return SendClientMessageEx(playerid, COLOR_WHITE, "[ ! ]: /createlocker [type, 1.POLISI 2.PEMERINTAH 3.MEDIS 4.PEMBAWA BERITA 5.PEDAGANG 6.GOJEK 7.VIP 8.FAMILY Locker]");
