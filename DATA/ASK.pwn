...
CMD:ans(playerid, params[])
{
    ...
    SendStaffMessage(COLOR_RED, "%s telah menjawab pertanyaan %s(%d).", pData[playerid][pUCP], pData[AskData[reportid][askPlayer]][pName], AskData[reportid][askPlayer]);
    pData[playerid][pAdminPoint] ++;
    Servers(AskData[reportid][askPlayer], "ANSWER: {FF0000}%s {FFFFFF}: %s.", pData[playerid][pUCP], msg);
