...
CreateServerPoint()
{
	...
	MaduPickup = CreateDynamicPickup(1239, 23, -546.57, -1504.23, 9.49, 0);
	format(strings, sizeof(strings), "{ffffff}Honeycomb\n{ffffff}Use: {ffff00}/unloadhoney\n{ffffff}Price: {00ff00}$100\n{ffffff}Untuk menjual madu ke pengepul");
	MaduText = CreateDynamic3DTextLabel(strings, COLOR_YELLOW, -546.57, -1504.23, 9.49, 5.0);
	...
	PedagangText = CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 1256.2795, -1281.5076, 1061.1492, 5.0); // Apotek hospital
	...
	ApotekPickup = CreateDynamicPickup(1241, 23, 964.37, 1955.88, -88.65, -1, -1, -1, 50.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/buy", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 964.37, 1955.88, -88.65, 5.0); // Apotek hospital
	...
	DrugText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 2537.0117,-1304.5032,34.9453, 5.0); // product

	ObatPickup = CreateDynamicPickup(1241, 23, 961.4221,-1746.7047,13.5705, -1, -1, -1, 50.0);
	...
	ObatText = CreateDynamic3DTextLabel(strings, COLOR_GREY, 961.4221,-1746.7047,13.5705, 5.0); // product
