...
stock CreateNotifyChat(const playerid, index, i, const Float:new_x)
{
		...
		TextDrawChat[++i] = TextDrawCreate(10.000, 232.000+posisibaru, "LD_BUM:blkdot");
		...
		TextDrawChat[++i] = TextDrawCreate(28.000, 236.000+posisibaru, " Twitter");
		...
		TextDrawChat[++i] = TextDrawCreate(15.000, 232.000+posisibaru, "LD_BEAT:chit");
		...
		TextDrawChat[++i] = TextDrawCreate(15.000, 245.000+posisibaru, "@ %s", InfoNotifyChat[playerid][index][NotifyMessage]);
		TextDrawLetterSize(TextDrawChat[i], 0.200, 0.899);
		TextDrawAlignment(TextDrawChat[i], 1);
		TextDrawColor(TextDrawChat[i], -1);
		TextDrawSetShadow(TextDrawChat[i], 0);
		...
		TextDrawChat[++i] = TextDrawCreate(18.000, 236.000+posisibaru, "HUD:radar_gangB");
		...
		TextDrawChat[++i] = TextDrawCreate(186.000, 235.000+posisibaru, "02:01");
